...
_DEFAULT_PCL_VERSION = "0.23.3"

_DOWNLOAD_URL = ("https://artifacts.apple.com/libs-release/com/apple/pcl/pcl-cli-{os}/{version}/pcl-cli-{os}-{version}.{ext}")
...
# docs tool to use `pcl-tools`, and that will avoid dragging kotlin into
# the exported PCL_DEPS
...
_PCL_VERSIONS = {
    "0.16.0": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.16.0",
            "com.apple.pcl:pcl-doc:0.16.0",
            "com.apple.pcl:pcl-codegen-java:0.16.0",
            "com.apple.pcl:pcl-config-java:0.16.0",
        ],
    },
    "0.17.0": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.17.0",
            "com.apple.pcl:pcl-doc:0.17.0",
            "com.apple.pcl:pcl-codegen-java:0.17.0",
            "com.apple.pcl:pcl-config-java:0.17.0",
        ],
    },
    "0.18.0": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.18.0",
            "com.apple.pcl:pcl-doc:0.18.0",
            "com.apple.pcl:pcl-codegen-java:0.18.0",
            "com.apple.pcl:pcl-config-java:0.18.0",
        ],
    },
    "0.19.2": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.19.2",
            "com.apple.pcl:pcl-doc:0.19.2",
            "com.apple.pcl:pcl-codegen-java:0.19.2",
            "com.apple.pcl:pcl-config-java:0.19.2",
        ],
    },
    "0.20.0": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.20.0",
            "com.apple.pcl:pcl-doc:0.20.0",
            "com.apple.pcl:pcl-codegen-java:0.20.0",
            "com.apple.pcl:pcl-config-java:0.20.0",
            "com.apple.pcl:pcl-tools:0.20.0",
        ],
    },
    "0.21.0": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.21.0",
            "com.apple.pcl:pcl-doc:0.21.0",
            "com.apple.pcl:pcl-codegen-java:0.21.0",
            "com.apple.pcl:pcl-config-java:0.21.0",
            "com.apple.pcl:pcl-tools:0.21.0",
        ],
    },
    "0.22.2": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.22.2",
            "com.apple.pcl:pcl-doc:0.22.2",
            "com.apple.pcl:pcl-codegen-java:0.22.2",
            "com.apple.pcl:pcl-config-java:0.22.2",
            "com.apple.pcl:pcl-tools:0.22.2",
        ],
    },
    "0.23.3": {
        "pcl_linux": {
        ...
        "java_deps": [
            "com.apple.pcl:pcl-apple:0.23.3",
            "com.apple.pcl:pcl-doc:0.23.3",
            "com.apple.pcl:pcl-codegen-java:0.23.3",
            "com.apple.pcl:pcl-config-java:0.23.3",
            "com.apple.pcl:pcl-tools:0.23.3",
        ],
    },
}
...
copy_file(
    ...
    src = select(
        {{
            "@apple_federation//common/configs:linux": "@pcl_{version}_linux//file:downloaded",
            "@apple_federation//common/configs:macos": "@pcl_{version}_macos//file:downloaded",
        }},
    ),
    out = "pcl",
    allow_symlink = True,
...
def pcl_deps(version = _DEFAULT_PCL_VERSION):
    """Pull in extra dependencies required by Pcl.

    Args:
      version: The version of Pcl to use (defaults to %s)""" % _DEFAULT_PCL_VERSION

    check_import_ordering(
        check_ruleset = "pcl_constants",
        federation_ruleset = "pcl_deps",
        known_conflicts = ["java_deps", "rio_deps"],
    )
    ruleset_pcl_deps(version)

def ruleset_pcl_deps(version = _DEFAULT_PCL_VERSION):
    """Internal to the Federation; please do not call"""

    if native.existing_rule("pcl_constants"):
    ...
    if not version in _PCL_VERSIONS.keys():
        fail("Unknown Pcl version. Supported versions are: %s" % ", ".join(_PCL_VERSIONS.keys()))

    version_deps = _PCL_VERSIONS[version]

    pcl_linux = version_deps["pcl_linux"]
    maybe(
        http_file,
        name = "pcl_%s_linux" % _underscore(version),
        sha256 = pcl_linux["sha256"],
        urls = [
            pcl_linux["url"],
        ],
        executable = True,
    ...
    pcl_mac = version_deps["pcl_mac"]
    maybe(
        http_file,
        name = "pcl_%s_macos" % _underscore(version),
        sha256 = pcl_mac["sha256"],
        urls = [
            pcl_mac["url"],
        ],
        executable = True,
    ...
    pcl_java = version_deps["pcl_java"]
    maybe(
        http_jar,
        name = "pcl_java",
        sha256 = pcl_java["sha256"],
        urls = [
            pcl_java["url"],
        ],
    )
