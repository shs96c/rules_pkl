...
def pkl_cli_binaries():
    maybe(
        http_file,
        name = "pkl-cli-macos",
        url = "https://artifacts.apple.com/artifactory/libs-release/com/apple/pkl/pkl-cli-macos/0.24.0/pkl-cli-macos-0.24.0.bin",
    ...
    maybe(
        http_file,
        name = "pkl-cli-linux",
        url = "https://artifacts.apple.com/artifactory/pcl-release-local/com/apple/pkl/pkl-cli-linux-amd64/0.24.2/pkl-cli-linux-amd64-0.24.2.bin",
        sha256 = "5b0dae4b238dfbb22dd4fd9343dcd586c44242ff56bac31f9ac60287662991f2",
        executable = True,
    )
